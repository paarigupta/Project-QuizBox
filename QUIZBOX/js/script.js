...
$(function(){
    ...
    let timer = setInterval(function(){
        ...
        $(".timerBox span").text(addZero(min)+":"+addZero(sec));
...
function checkAnswer(option){
    ...
    $(".optionBox span").attr("onclick","");    // to prevent multiple click on option
}
...
{
    if (j==1 && index<questions.length -1 && !confirm("Quiz has not finished yet. Press OK for skip quiz and get your final result"))
    {
        return;
    }
        result();
